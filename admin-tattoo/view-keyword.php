<?php $curPage='user';
$curSubPage='view_address'; 
include("includes/header.php");

/* ******** start delete record ************** */
if ((isset($_GET['delid']) && $_GET['delid'] != ""))
{	
	$dataDel = $obj->getRowFromAnyTable('keyword','id',$_GET['delid']);
	 
	$obj->deleteRowFromAnyTable('keyword','id',$_GET['delid']);
...
if ((isset($_POST['sub_multiform']) && $_POST['sub_multiform'] != "" && $_POST['sub_multiform'] == "delete"))
{
	...
	{
		$dataDel = $obj->getRowFromAnyTable('keyword','id',$_POST['checkbox'][$di]);
		 
		$obj->deleteRowFromAnyTable('keyword','id',$_POST['checkbox'][$di]);
...
{	
	...
	$obj->updateRowFromAnyTable('keyword','status="'.$update.'"','id="'.$_GET['statusid'].'"');
...
if((isset($_POST['sub_multiform']) && $_POST['sub_multiform'] != "" && $_POST['sub_multiform'] == "status"))
{
	for($di=0;$di<count($_POST['checkbox']);$di++)
	{
		$dataStatus = $obj->getRowFromAnyTable('keyword','id',$_POST['checkbox'][$di]);
		$update= ($dataStatus['status'] == 1) ? 2 : 1;
		$obj->updateRowFromAnyTable('keyword','status="'.$update.'"','id="'.$_POST['checkbox'][$di].'"');
...
$sql = "SELECT * FROM `keyword` WHERE 1=1 "; 
  ...
  <div id="content">
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
      ...
      <tr>
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                  <thead>
                    <tr>
                      ...
                      <th class="table-header-repeat line-left minwidth-1"><a onclick="SortTable(2);" href="javascript:;">Keyword</a></th>
        ...
        <a href="add-keyword.php<?php echo DEF_QRY_STR;?>&editid=<?php echo $data['id'];?>&pagename=1" title="Edit keyword" class="icon-1 info-tooltip"></a>
