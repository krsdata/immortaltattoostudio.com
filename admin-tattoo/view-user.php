                  ...
                  <form name="addEditForm" id="addEditForm" method="post" action="" enctype="multipart/form-data">
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
					  ...
					  <tr>
					   ...
					   <tr> 
                        <th valign="top"></th>
                        <td><input type="text" class="inp-form1  required" name="file_on" readonly="readonly" id="file_on" value="<?php echo $_POST['filled_no_text']=='' ? $datauser['filled_no_text'] : $_POST['filled_no_text'];?>"/> 
						 <input type="text" class="inp-form1 " name="filled_no" id="filled_no" readonly="readonly" value="<?php echo $_POST['filled_no']=='' ? $datauser['filled_no'] : $_POST['filled_no'];?>"  placeholder="Enter Date"/></td>
                        <td><div id="filled_on_dateError" class="errormessage"></div></td>
                      </tr> 
					  ...
					  <?php while($row=mysql_fetch_array($datauser2)) { ?> 
					   <tr>
                        <th valign="top" style="float: left; margin-left: 15px;">Stamp:</th>
						 <th valign="top">Case Number:</th>
						 </tr>
						 <tr id="stamp_case" class="stamp_case"> 
                        <td style="float: left; margin-left: 15px;"><input type="text" readonly="readonly" class="inp-form1 required" name="stamp[]"  value="<?php echo $row['stamp']; ?>" /> <br /><br />
						<input type="text" class="inp-form1 " name="stamp_yr[]" id="stamp_yr" readonly="readonly"   value="<?php echo $row['stamp_yr']; ?>" />
						</td> 
                        
                        <td><input type="text" class="inp-form1 required" name="case_no[]" id="case_no"   readonly="readonly" value="<?php echo $row['case_no']; ?>"/> <br /><br />
						<input type="text" class="inp-form1 " name="case_no_yr[]" id="case_no_yr"  readonly="readonly"  value="<?php echo $row['case_no_yr']; ?>" style="float:left" /> 
					  ...
					  <tr>
                        ...
                        <td><input type="text" class="inp-form1  number required"  readonly="readonly" name="fee_agreed" id="fee_agreed" value="<?php echo $_POST['fee_agreed']=='' ? $datauser['fee_agreed'] : $_POST['fee_agreed'];?>"/>
						<input type="text" class="inp-form1 required" name="fee_agreed_date" readonly="readonly"   value="<?php echo $_POST['fee_agreed_date']=='' ? $datauser['fee_agreed_date'] : $_POST['fee_agreed_date'];?>" placeholder="Enter Date"/>
						</td>
					  ...
					  if(count($fee_paid_date)>0)
					  {
					  
					  for($i=0; $i<count($fee_paid_date); $i++)
					  {
					   ?>
					   <tr>
                        <th valign="top">Fee paid:</th>
                        <td>
						<input type="text" class="inp-form1   required" name="paid_item_name" readonly="readonly"   value="<?php echo $paid_item_name[$i];  ?>" />
						<input type="text" class="inp-form1  number required" name="fee_paid" readonly="readonly"   value="<?php echo $fee_paid[$i];  ?>" />
						<input type="text" class="inp-form1  required " name="fee_paid_date" readonly="readonly"   value="<?php echo $fee_paid_date[$i]; ?>"  />
						</td>
                    
                      </tr>
					   <?php }} ?>
					    <?php $expense_date =  explode(',',$datauser['expense_date']);
						$expense =  explode(',',$datauser['expense']); 
					    $expense_item_name =  explode(',',$datauser['expense_item_name']);
					  if(count($expense_date)>0)
					  {
					  ...
					  <tr>
                        ...
                        <td>
						<input type="text" class="inp-form1   required" name="expense_item_name" readonly="readonly" id="expense_item_name" value="<?php echo $expense_item_name[$i];?>"/>
						<input type="text" class="inp-form1  number required" name="expense" readonly="readonly" id="expense" value="<?php echo $expense[$i];?>"/>
						<input type="text" class="inp-form1   required" name="expense_date" readonly="readonly"   value="<?php echo $expense_date[$i];?>" placeholder="Enter Date"/>
						</td>
					  ...
					  <tr>
                        ...
                        <td><input type="text" class="inp-form1  number  required"  readonly="readonly"  name="blance"   value="<?php echo $_POST['blance']=='' ? $datauser['blance'] : $_POST['blance'];?>"/></td>
					...
					<?php  }?>
					  ...
					  <?php } } ?>
					   ...
					   <tr>
						...
						<input type="text" class="inp-form1   " name="case_reg_date" readonly="readonly"   value="<?php echo $_POST['case_reg_date']=='' ? $datauser['case_reg_date'] : $_POST['case_reg_date'];?>"  placeholder="Enter Date" />
					  ...
					  <tr>
                        ...
                        <td><input type="text" class="inp-form1  required " readonly="readonly" name="calender"   value="<?php echo $_POST['calender']=='' ? $datauser['calender'] : $_POST['calender'];?>"/></td>
