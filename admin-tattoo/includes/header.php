...
<title>Immortal Tattoo Admin</title>
...
$(function()
{
 $('.datepick,#search_by_date').live('focus',function(){
...
$("#filled_on_date,#fee_agreed_date,#fee_paid_date,#case_reg_date,#date-pick,#expense_date1").datePicker(
		// associate the link with a date picker
		{
			createButton:false,
			startDate:'01/01/2005',
  ...
  <div class="nav-outer">
    ...
    <div id="nav-right">
      ...
      <div class="account-content">
		...
		?>
		 <div class="acc-line">&nbsp;</div>
             <a href="add-edit-admin-user.php" id="acc-details">Add User</a>
			 <div class="clear">&nbsp;</div>
        <div class="acc-line">&nbsp;</div>
